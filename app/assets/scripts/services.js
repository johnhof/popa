...
popa.service('Session', ['Cookie', 'Api', '$route', '$window', function (Cookie, Api, $route, $window) {
  var session = {
    nickname   : null,
    email      : null,
    isSignedIn : false,
...
popa.service('Utils', ['Cookie', 'Api', '$route', '$window', '$location', function (Cookie, Api, $route, $window, $location) {
